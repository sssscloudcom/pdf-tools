...
supportedLanguages.forEach(lang => {
  routes.forEach(route => {
    ...
    let html = baseHtml
      ...
      .replace(/<!-- Canonical will be dynamically updated -->/, hreflangTags + `    <link rel="canonical" href="https://pdftools.nextapi.pro/${lang}${route.path}" />`)
...
console.log(`Total: ${supportedLanguages.length * routes.length} files`)